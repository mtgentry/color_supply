<template lang="pug">
  div#actions(ref="actions")
    ...
    v-btn.actionBtn(flat @click="toggleInfo" :disabled="!palette" :active="info")
      svg.mr-1(xmlns='http://www.w3.org/2000/svg', width='15', height='16', fill='none')
        path(d='M14.625 7.5c0 3.935-3.19 7.125-7.125 7.125S.375 11.435.375 7.5 3.565.375 7.5.375s7.125 3.19 7.125 7.125z', fill='#fff', :stroke="palette ? 'var(--color4)' : 'var(--color5)'", stroke-width='.75')
        path(d='M7.486 12.182c-.507 0-.793-.325-.793-.91V6.358c0-.585.286-.91.793-.91s.793.325.793.91v4.914c0 .585-.286.91-.793.91zm-.949-8.32a.94.94 0 0 1 .962-.962.94.94 0 0 1 .962.962.94.94 0 0 1-.962.962.94.94 0 0 1-.962-.962z', :fill="palette ? 'var(--color4)' : 'var(--color5)'")
      | Info
