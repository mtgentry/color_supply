<template lang="pug">
  v-tabs(v-model='colorTab' dense  align-tabs="center")
    v-tab(value='color' :class="{'is_selected': colorTab === 'color'}" v-ripple="{ class: `text-primary` }")
    ...
    v-tab(value='wheel' :class="{'is_selected': colorTab === 'wheel'}" v-ripple="{ class: `text-primary` }")
      svg(width='23' height='24' viewbox='0 0 23 24' fill='none' xmlns='http://www.w3.org/2000/svg')
        g
    ...
    v-tab(value='list' :class="{'is_selected': colorTab === 'list'}" v-ripple="{ class: `text-primary` }")
